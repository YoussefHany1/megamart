...
function Footer() {
  return (
    <>
      <footer
        className={`footer bg-primary text-white position-relative overflow-hidden pt-5 ${styles.footer}`}
      >
        <div className="text position-relative d-sm-flex d-block pb-5">
          <div className="contactUs d-flex flex-column justify-content-between pe-md-5 me-md-5">
            <Link
              href="/"
              className="text-decoration-none pb-2 text-white fw-bold fs-1"
            >
              MegaMart
            </Link>
            <div className="fw-medium fs-4 pb-2">
              <b>Contact US</b>
            </div>
            <div className="whatsapp">
              <div className="text fw-medium fs-5">
                <svg fill="#fff">
                  {" "}
            ...
            <div className="app">
              <div className="text pb-2 fw-medium fs-5">
                <b>Download App</b>
              </div>
          ...
          <div className="popular d-none d-sm-flex flex-column justify-content-between px-5">
            <div
              className={`headerColumn text-white fw-semibold fs-5 ${styles.headerColumn}`}
            >
              Most Popular Categories
            </div>
            <ul
              className={`list d-flex flex-column justify-content-between fw-medium ms-1 mt-4 h-100 ${styles.list}`}
            >
              <li>
