      ...
      <section className="phone-brands my-5 py-3">
        <div className="header text-secondary d-flex justify-content-between fw-bold">
          <div className="line fs-4 pb-3">
            Top <p className="text-primary d-inline">SmartPhone Brands</p>
          </div>
          <Link
            href="/phones"
        ...
        <div className={`brands mt-5 py-4 ${styles.brands}`}>
          <Splide
            options={{
              ...
              pagination: false,
              perPage: 4,
              autoScroll: { speed: 2, pauseOnHover: true },
            }}
            extensions={{ AutoScroll }}
          >
            <SplideSlide>
              <Link href="/phones" className="image">
                <Image
                  width={300}
                  height={300}
                  src="phone-brands/apple.webp"
                  alt="Apple"
                  className={`rounded-4 img-fluid ${styles.brands}`}
                />
              </Link>
            </SplideSlide>
            <SplideSlide>
