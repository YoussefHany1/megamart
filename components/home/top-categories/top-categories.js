    ...
    return (
        <>
            <section className="topCat mb-0 mb-lg-5 pb-0 pb-lg-3">
                ...
                <div className={`categories d-flex justify-content-center text-center row mt-5 ${styles.categories}`}>
                    <div className={`cat col mb-5 mb-lg-0 ${styles.cat}`}>
                    ...
                    <div className={`cat col mb-5 mb-lg-0 ${styles.cat}`}>
                        <div className={`photo rounded-circle align-content-center ${styles.photo}`}><img src="./top-categories/cosmetics.png" alt="Beauty" /></div>
                        <div className="text mt-3"><a href="#" className="text-black text-decoration-none fw-medium">Beauty</a></div>
                    </div>
                    <div className={`cat col mb-5 mb-lg-0 ${styles.cat}`}>
                        <div className={`photo rounded-circle align-content-center ${styles.photo}`}><img src="./top-categories/electronics.png" alt="Electronics" /></div>
                        <div className="text mt-3"><a href="#" className="text-black text-decoration-none fw-medium">Electronics</a></div>
                    </div>
                    <div className={`cat col mb-5 mb-lg-0 ${styles.cat}`}>
                        <div className={`photo rounded-circle align-content-center ${styles.photo}`}><img src="./top-categories/furniture.png" alt="Home Appliances" /></div>
                    ...
                    <div className={`cat col mb-5 mb-lg-0 ${styles.cat}`}>
                        <div className={`photo rounded-circle align-content-center ${styles.photo}`}><img src="./top-categories/decor.png" alt="Home Decor" /></div>
                        <div className="text mt-3"><a href="#" className="text-black text-decoration-none fw-medium">Home Decor</a></div>
                    </div>
                    <div className={`cat col mb-5 mb-lg-0 ${styles.cat}`}>
                        <div className={`photo rounded-circle align-content-center ${styles.photo}`}><img src="./top-categories/accessories.png" alt="Accessories" /></div>
