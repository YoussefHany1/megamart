    ...
    return (
        <>
            <section className="topCat mb-0 mb-lg-5 pb-0 pb-lg-3">
                ...
                <div className={`categories row justify-content-evenly flex-wrap text-center mt-5 ${styles.categories}`}>
                    <div className={`cat mb-5 col-6 col-md-4 col-lg-3 mb-lg-0 ${styles.cat}`}>
                        <div className={`photo rounded-circle align-content-center ${styles.photo}`}><img src="./top-categories/mobile.webp" alt="Mobiles" /></div>
                        <div className="text mt-3"><a href="/phones" className="text-black text-decoration-none fw-medium">Mobiles</a></div>
                    </div>
                    <div className={`cat mb-5 col-6 col-md-4 col-lg-3 mb-lg-0 ${styles.cat}`}>
                        <div className={`photo rounded-circle align-content-center ${styles.photo}`}><img src="./top-categories/watches.webp" alt="Wearables" /></div>
                        <div className="text mt-3"><a href="/wearables" className="text-black text-decoration-none fw-medium">Wearables</a></div>
                    </div>
                    <div className={`cat mb-5 col-6 col-md-4 col-lg-3 mb-lg-0 ${styles.cat}`}>
                        <div className={`photo rounded-circle align-content-center ${styles.photo}`}><img src="./top-categories/tv.webp" alt="Accessories"  className="w-100 p-2" /></div>
                        <div className="text mt-3"><a href="/television" className="text-black text-decoration-none fw-medium">Televisions</a></div>
                    </div>
                    <div className={`cat mb-5 col-6 col-md-4 col-lg-3 mb-lg-0 ${styles.cat}`}>
                        <div className={`photo rounded-circle align-content-center ${styles.photo}`}><img src="./top-categories/pc.webp" alt="Accessories"  className="w-100 p-3" /></div>
