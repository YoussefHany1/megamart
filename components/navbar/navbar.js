      ...
      <nav>
        <div className="welcome d-lg-flex d-none justify-content-between align-items-center py-2">
          ...
          <div className="d-flex">
            ...
            >
              <svg className="mx-1" viewBox="0 0 24 24" fill="none">
                <path
            ...
            >
              <svg className="mx-1" viewBox="0 0 48 48" fill="none">
            ...
            <a
              ...
              className="text-decoration-none mx-2 d-flex align-items-center"
            >
              <svg className="mx-1" viewBox="0 0 16 16">
                <path
                  fillRule="evenodd"
        ...
        <Link
          href="/"
          className="logo text-lg-start text-center text-primary mt-2 fs-1 text-decoration-none fw-bold d-sm-none d-block"
        >
          MegaMart
        </Link>
        <div className="nav py-3 d-flex justify-content-between flex-nowrap align-items-center">
          <div className="menu d-flex">
            <span>
              <button
                type="button"
                className="btn rounded-3 navbar-toggler p-2 me-3"
                variant="primary"
                onClick={handleShow}
              >
          ...
          <Link
            href="/"
            className="logo text-lg-start text-center fs-2 ps-3 pe-5 text-decoration-none fw-bold d-sm-block d-none"
          >
            MegaMart
          </Link>
          <div className="search rounded-3 d-flex w-100 flex-nowrap mx-0 mx-lg-auto ">
            <button className="border-0 ms-lg-4 ms-3 bg-transparent">
            ...
            <input
              type="text"
              className="border-0 rounded-3 py-3 ms-lg-4 ms-2 w-75"
          ...
          <div className="sign align-items-center d-none d-lg-flex ms-5">
            ...
            >
              <svg className="me-2" fill="currentColor">
          ...
          <Nav className="collapse navbar-collapse py-3 px-3 justify-content-between m-0">
            <Nav.Item>
              <Nav.Link
                ...
                className="rounded-5 px-3 py-2 mb-3 mb-xxl-0"
              >
                Mobiles & Accessories
              </Nav.Link>
            </Nav.Item>
