                ...
                <div className="contactUs d-flex flex-column justify-content-between pe-5 me-5">
                    ...
                    <div className="app">
                        ...
                        <div className="photos d-flex justify-content-between">
                            <a href="#" className='me-1'><img src={apple} alt="APP Store" className="apple img-fluid" /></a>
                            <a href="#" className='ms-1'><img src={google} alt="Google Play" className="google img-fluid" /></a>
                        </div>
                    </div>
                </div>
