...
const CATEGORIES = [
  { id: "phones", label: "Mobiles & Accessories", href: "/product-page/phones" },
  { id: "computers", label: "Computers & Accessories", href: "/product-page/computers" },
  { id: "wearables", label: "Wearables", href: "/product-page/wearables" },
  { id: "video-games", label: "Video Games", href: "/product-page/video-games" },
  { id: "camera", label: "Camera", href: "/product-page/camera" },
  { id: "tablets", label: "Tablets", href: "/product-page/tablets" },
  { id: "television", label: "Television", href: "/product-page/television" },
];
