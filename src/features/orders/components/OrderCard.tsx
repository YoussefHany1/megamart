...
export default function OrderCard({ order, onCancel }: { order: Order, onCancel: (id: string) => void }) {
  const statusClass = STATUS_STYLES[(order.status as any)] || STATUS_STYLES.default;
